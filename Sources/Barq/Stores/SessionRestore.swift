...
/// A restorable snapshot of an open tab: which profile, and where it was.
...
enum SessionRestore {
    ...
    @MainActor
    static func snapshot(from tabs: [TerminalTab], sessions: SessionManager) -> [RestorableSession] {
